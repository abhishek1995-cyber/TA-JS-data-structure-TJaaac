...
movies[0].actors[movies[0].actors.length-2]
// 9. Log the name of the second actor (index 1) of the second movie
movies[1].actors[movies[1].actors.length-2]
...
movies[movies.length-1].actors[movies[movies.length-1].actors.length-2]
// 12. Log all the genres of the third movie
movies[movies.length-1].genres
...
movies[movies.length-2].genres[movies.length-3]
